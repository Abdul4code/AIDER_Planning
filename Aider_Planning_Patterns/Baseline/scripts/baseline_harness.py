...
Runs benchmark tasks with plain execution (no decomposition planner), while
writing `.aider.results.json` files compatible with collect_results.py.
"""
...
def main() -> int:
    ...
    print(f"Baseline harness run root: {run_root}")
    ...
    print("Baseline harness completed")
    return 0
